  ...
  const categoryConfig =
    feed.category === "Berita"
      ...
      : feed.category === "Tutorial"
        ...
        : { 
            badge: "bg-fuchsia-500/20 text-fuchsia-300 ring-1 ring-fuchsia-500/30",
        ...
        <div className="flex flex-1 flex-col justify-between">
          ...
          <div>
            <div className="mb-2.5 flex items-center gap-2">
              <span className={`inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-xs font-semibold ${categoryConfig.badge}`}>
            ...
            <div className="rounded-lg border border-cyan-500/20 bg-gradient-to-br from-cyan-500/5 to-blue-500/5 p-2.5 shadow-sm">
              <div className="mb-1.5 flex items-center gap-1.5">
                ...
                <span className="text-xs font-semibold text-cyan-300">Inti Cepat</span>
              </div>
          ...
          <div className="mt-3 flex items-center gap-2 text-xs">
            <svg className="h-3.5 w-3.5 text-cyan-400/80" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
            </svg>
            <span className="font-medium text-cyan-400 transition-colors group-hover:text-cyan-300">Buka Chat Q&A</span>
            <svg className="ml-auto h-3 w-3 text-cyan-400 transition-transform group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
