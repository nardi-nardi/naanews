    ...
    >
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="relative h-44 w-full shrink-0 overflow-hidden sm:h-auto sm:w-48 md:w-56">
          ...
          {/* Play / Step badge on image */}
          <div className="absolute bottom-3 left-3 flex items-center gap-1.5 rounded-lg bg-black/60 px-2.5 py-1 text-[11px] font-semibold text-white backdrop-blur-sm sm:bottom-auto sm:left-auto sm:right-3 sm:top-3">
        ...
        <div className="flex flex-1 flex-col justify-between p-4 sm:p-5">
          <div>
            ...
            <div className="mb-3 flex items-center gap-2">
              <span className="inline-flex items-center gap-1 rounded-md bg-cyan-500/15 px-2 py-0.5 text-[11px] font-bold uppercase tracking-wider text-cyan-300 ring-1 ring-cyan-500/25">
            ...
            {/* Title */}
            <h3 className="text-base font-bold leading-snug text-slate-50 transition-colors group-hover:text-cyan-200 sm:text-lg">
              {feed.title}
            </h3>
            ...
            <div className="mt-3 space-y-2">
              <div className="flex items-start gap-2 text-[13px]">
                <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-blue-500/20 text-[10px] font-bold text-blue-300">Q</span>
                <p className="text-slate-400 line-clamp-1">{feed.lines[0]?.text}</p>
              </div>
              {feed.lines[1] ? (
                <div className="flex items-start gap-2 text-[13px]">
                  <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-emerald-500/20 text-[10px] font-bold text-emerald-300">A</span>
                  <p className="text-slate-300 line-clamp-2">{feed.lines[1].text}</p>
                </div>
              ) : null}
            </div>
          </div>
          ...
          <div className="mt-4 flex items-center justify-between border-t border-slate-700/50 pt-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1">
                ...
                {stepCount > 5 ? (
                  <span className="ml-1 text-[10px] text-slate-500">+{stepCount - 5}</span>
                ) : null}
              </div>
            </div>

            <span className="flex items-center gap-1.5 text-xs font-semibold text-cyan-300 transition-colors group-hover:text-cyan-200">
              Mulai belajar
